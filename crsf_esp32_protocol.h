...
#define CRSF_FRAMETYPE_VTX_TELEMETRY 0x10
#define CRSF_FRAMETYPE_BAROMETER 0x11
#define CRSF_FRAMETYPE_MAGNETOMETER 0x12
#define CRSF_FRAMETYPE_ACCEL_GYRO 0x13
